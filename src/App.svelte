...
{:else if currentScreen === 'options'}
  <OptionsScreen
    ...
    getReverb={(i) => (samplerEngine ? samplerEngine.getReverb(i) : 0)}
    getDelay={(i) => (samplerEngine ? samplerEngine.getDelay(i) : 0)}
    ...
    setReverb={(i, a) => (samplerEngine ? samplerEngine.setReverb(i, a) : false)}
